...
extraction_prompt = PromptTemplate(
    ...
    template="""
You are a construction bid data extractor. Extract ALL plan pricing information from this document.
...
def save_extracted_data(all_bids, output_path="./extracted_bids.json"):
